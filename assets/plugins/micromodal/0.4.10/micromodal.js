        ...
        i = function () {
            function o(e) {
                ...
                !function (e, t) {
                    ...
                    this.modalPopup = document.getElementById(n),
                    this.config = {
                        debugMode: C,
                        disableScroll: b,
                        openTrigger: u,
                ...
                (a = [{
                    ...
                    value: function () {
                        ...
                        if (this.activeElement = document.activeElement,
                            this.modalPopup.setAttribute("aria-hidden", "false"),
                            this.modalPopup.classList.add(this.config.openClass),
                            this.scrollBehaviour("disable"),
                            this.addEventListeners(),
                            this.config.awaitOpenAnimation) {
                            var o = function t() {
                                e.modalPopup.removeEventListener("animationend", t, !1),
                                    e.setFocusToFirstNode()
                            };
                            this.modalPopup.addEventListener("animationend", o, !1)
                        } else
                            this.setFocusToFirstNode();
                        this.config.onShow(this.modalPopup, this.activeElement, t)
                    }
                }, {
                    key: "closeModal",
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null
                            , t = this.modalPopup;
                        if (this.modalPopup.setAttribute("aria-hidden", "true"),
                            this.removeEventListeners(),
                            this.scrollBehaviour("enable"),
                            this.activeElement && this.activeElement.focus && this.activeElement.focus(),
                            this.config.onClose(this.modalPopup, this.activeElement, e),
                            this.config.awaitCloseAnimation) {
                            var o = this.config.openClass;
                            this.modalPopup.addEventListener("animationend", (function e() {
                    ...
                    key: "closeModalById",
                    value: function (e) {
                        this.modalPopup = document.getElementById(e),
                            this.modalPopup && this.closeModal()
                    }
                }, {
                    key: "scrollBehaviour",
                    value: function (e) {
                    ...
                    value: function () {
                        this.modalPopup.addEventListener("touchstart", this.onClick),
                            this.modalPopup.addEventListener("click", this.onClick),
                            document.addEventListener("keydown", this.onKeydown)
                    }
                }, {
                    key: "removeEventListeners",
                    value: function () {
                        this.modalPopup.removeEventListener("touchstart", this.onClick),
                            this.modalPopup.removeEventListener("click", this.onClick),
                    ...
                    value: function () {
                        var e = this.modalPopup.querySelectorAll(n);
                    ...
                    value: function (e) {
                        ...
                        if (0 !== t.length)
                            if (t = t.filter((function (e) {
                                ...
                                this.modalPopup.contains(document.activeElement)) {
